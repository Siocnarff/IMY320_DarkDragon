...
<template>
  <div class="main">
    <div id="header">
      <img id="header_image" src="../assets/Main.png">
      <div id="headings">
        <h1 id="header_heading"><span style="color:#DCE0D9">SOFTWARE FOR THE</span><span
            style="color:#DB162F"> BRAVE</span></h1>
        <p id="header_subtext">Wherever we need to go...</p>
      </div>
      <img id="diver_image" src="../assets/Diver.png">
    ...
    <ul id="v-for-object" class="demo">
      <li v-for="value in items" :key="value.id" class="projects">
